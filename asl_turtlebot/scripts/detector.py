...
class Detector:
    ...
    def project_pixel_to_ray(self,u,v):
        ...
        x = (u - self.cx)/float(self.fx)
        y = (v - self.cy)/float(self.fy)
    ...
    def camera_info_callback(self, msg):
        ...
        ### MY CODE HERE ###        
        print("This should be K: ")
        print(msg.K)

        msgMatrix = msg.K
        self.cx = msgMatrix[2] # CHANGE ME
        self.cy = msgMatrix[5] # CHANGE ME
        self.fx = msgMatrix[0] # CHANGE ME
        self.fy = msgMatrix[4] # CHANGE ME
        ### END OF MY CODE ###
